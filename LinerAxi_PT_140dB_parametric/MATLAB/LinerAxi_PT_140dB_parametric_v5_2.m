function LinerAxi_PT_155dB_parametric_v5_2(SPL,d_h,POA,h_h,h_r,cycles,freq)
%
% LinerAxi_PT_130dB_parametric_v5_2.m using option to choose the SPL
%
...
%SPL=130; %Sound pressure level dB
k0=w/c0; %wave number
