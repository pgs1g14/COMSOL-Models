...
model.label('LinerAxi_PT_155dB_500Hz_v5.2.mph');
...
model.param.set('f0', '600[Hz]', 'Driving frequency');
...
model.param.set('dt_sol', '0.0001[s]', 'Solver time step (resolve f0 with T0/30)');
model.param.set('lmesh', 'c0*dt_sol[m]', 'Minimum element size acoustic mesh');
